...
function N$3(e,...t){const n=new URL("https://lexical.dev/docs/error"),o=new URLSearchParams;o.append("code",e);for(const e of t)o.append("v",e);throw n.search=o.toString(),Error(`Minified Lexical error #${e}; visit ${n.toString()} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`)}const C$2=new Map;function I$4(e){const t={};if(!e)return t;const n=e.split(";");for(const e of n)if(""!==e){const[n,o]=e.split(/:([^]+)/);n&&o&&(t[n.trim()]=o.trim());}return t}function B$2(e){let t=C$2.get(e);return void 0===t&&(t=I$4(e),C$2.set(e,t)),t}function F$2(e){let t="";for(const n in e)n&&(t+=`${n}: ${e[n]};`);return t}function b$1(e,o){const l=e.getStartEndPoints();if(o.isSelected(e)&&!Zi(o)&&null!==l){const[t,r]=l,s=e.isBackward(),i=t.getNode(),c=r.getNode(),f=o.is(i),u=o.is(c);if(f||u){const[t,l]=dr(e),r=i.is(c),f=o.is(s?c:i),u=o.is(s?i:c);let g,a=0;if(r)a=t>l?l:t,g=t>l?t:l;else if(f){a=s?l:t,g=void 0;}else if(u){a=0,g=s?t:l;}o.__text=o.__text.slice(a,g);}}return o}function z$4(e){const t=e.getStyle(),n=I$4(t);C$2.set(t,n);}function A$3(t,n){(cr(t)?t.isCollapsed():Qn(t)||di(t))||N$3(280);const l=B$2(cr(t)?t.style:Qn(t)?t.getStyle():t.getTextStyle()),r=Object.entries(n).reduce(((e,[n,o])=>("function"==typeof o?e[n]=o(l[n],t):null===o?delete e[n]:e[n]=o,e)),{...l}),s=F$2(r);cr(t)||Qn(t)?t.setStyle(s):t.setTextStyle(s),C$2.set(s,r);}function M$7(e,t){if(cr(e)&&e.isCollapsed()){A$3(e,t);const n=e.anchor.getNode();di(n)&&n.isEmpty()&&A$3(n,t);}L$3((e=>{A$3(e,t);}));}function L$3(n){const o=Nr();if(!o)return;const l=new Map;if(cr(o))for(const e of fl(o).getTextSlices())e&&l.set(e.caret.origin.getKey(),e.getSliceIndices());const r=o.getNodes();for(const o of r){if(!Qn(o)||!o.canHaveFormat())continue;const[r,i]=(s=o,l.get(s.getKey())||[0,s.getTextContentSize()]);if(i!==r)if(Zi(o)||0===r&&i===o.getTextContentSize())n(o);else {n(o.splitText(r,i)[0===r?0:1]);}}var s;cr(o)&&"text"===o.anchor.type&&"text"===o.focus.type&&o.anchor.key===o.focus.key&&$$3(o);}function $$3(e){if(e.isBackward()){const{anchor:t,focus:n}=e,{key:o,offset:l,type:r}=t;t.set(n.key,n.offset,n.type),n.set(o,l,r);}}function W$3(e){const t=e.anchor.getNode(),n=yi(t)?t:t.getParentOrThrow(),o=xo().getElementByKey(n.getKey());if(null===o)return  false;const r=o.ownerDocument.defaultView;if(null===r)return  false;return "vertical-rl"===r.getComputedStyle(o).writingMode}function X$3(e,t){const n=W$3(e)?!t:t,l=ll(e.focus,n?"previous":"next");if(yl(l))return  false;for(const e of Qo(l)){if(Ko(e))return !e.origin.isInline();if(!di(e.origin)){if(_i(e.origin))return  true;break}}return  false}function q$3(e,t,n,o){e.modify(t?"extend":"move",n,o);}function G$2(e){const t=e.anchor.getNode();return "rtl"===(yi(t)?t:t.getParentOrThrow()).getDirection()}function J$4(e,t,n){const o=G$2(e);let l;l=W$3(e)||o?!n:n,q$3(e,t,l,"character");}function Q$3(e,t,n){const o=B$2(e.getStyle());return null!==o&&o[t]||n}function Y$3(t,n,o=""){let l=null;const r=t.getNodes(),s=t.anchor,i=t.focus,f=t.isBackward(),u=f?i.offset:s.offset,g=f?i.getNode():s.getNode();if(cr(t)&&t.isCollapsed()&&""!==t.style){const e=B$2(t.style);if(null!==e&&n in e)return e[n]}for(let t=0;t<r.length;t++){const s=r[t];if((0===t||0!==u||!s.is(g))&&Qn(s)){const e=Q$3(s,n,o);if(null===l)l=e;else if(l!==e){l="";break}}}return null===l?o:l}
...
function styleFilterHook(_currentNode, hookEvent) {
  if (hookEvent.attrName === "style" && hookEvent.attrValue) {
    const styles = { ...B$2(hookEvent.attrValue) };
    ...
    if (Object.keys(sanitizedStyles).length) {
      hookEvent.attrValue = F$2(sanitizedStyles);
    } else {
...
class Highlighter {
  ...
  toggle(styles) {
    this.editor.update(() => {
      ...
      L$3(node => this.#syncHighlightWithStyle(node));
    });
  }
  ...
  #hasHighlightStyles(node) {
    const styles = B$2(node.getStyle());
  ...
  static importDOM() {
    return {
      ...
      pre: (element) => onlyPreLanguageElements(element, {
        conversion: extendConversion(K$1, "pre", applyLanguage),
        priority: 1
      })
    }
  }
...
class LexicalEditorElement extends HTMLElement {
  ...
  #handleFocus() {
    ...
    this.editor.registerCommand(Ge$1, () => { dispatch(this, "lexxy:blur"); }, zi);
    this.editor.registerCommand(qe$1, () => { dispatch(this, "lexxy:focus"); }, zi);
  }
