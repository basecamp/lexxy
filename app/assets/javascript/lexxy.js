...
class LexicalToolbarElement extends HTMLElement {
  ...
  #updateColorButtonStates() {
    ...
    const textColor = le$1(selection, "color", "");
    const backgroundColor = le$1(selection, "background-color", "");
...
function sanitize(html) {
  ...
  purify.removeHook("uponSanitizeAttribute", styleFilterHook);
